...
public class Main {
    ...
    private static Location getLocationFromCode(final DepartmentCode code) {
        return code.getLocation();
    }

    private static DepartmentCode copyCode(final DepartmentCode code) {
        return code.copy();
    }

    private static void printCode(final DepartmentCode code,
                                  final String name) {
        System.out.printf("The IBM department " + name + " is: %s\n", code);
    }

    private static boolean compareCodes(final DepartmentCode code1,
                                        final DepartmentCode code2) {
    ...
    private static Pair<DepartmentCode, DepartmentCode> createCodes() {
        ...
        final DepartmentCode code1 = DepartmentCode.of("112334");
        final DepartmentCode code2 = DepartmentCode.of("456789");
